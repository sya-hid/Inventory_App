...
import com.syarifhidayatullah.myapplication.BuildConfig
import com.syarifhidayatullah.myapplication.Dashnet
import com.syarifhidayatullah.myapplication.utils.Helpers
...
class HttpClient {
    ...
    private fun buildRetrofitClient() {
        val token = Dashnet.getApp().getToken()
    ...
    fun buildRetrofitClient(token: String?) {
       ...
       if (BuildConfig.DEBUG) {
            ...
            builder.addInterceptor(ChuckInterceptor(Dashnet.getApp()))
        }
